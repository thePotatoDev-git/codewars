...
function numberJoy(n) {
    ...
    const sumOfDigits = digits.reduce((a, b) => a + parseInt(b), 0);
    const reversedSum = sumOfDigits.toString().split('').reverse().join('');
    const product = sumOfDigits * parseInt(reversedSum);
    return product === n;
}